...
force force ace_rearm_distance = 29.5972;
...
force force acex_volume_reduction = 3;
...
force force lambs_main_minFriendlySuppressionDistance = 14.9937;
force force lambs_main_minSuppressionRange = 100;
