...
Achilles_var_OM_AAF = true;
Achilles_var_OM_AAF_BLU = true;
Achilles_var_OM_AMP = true;
Achilles_var_OM_CSAT = true;
Achilles_var_OM_FIA = true;
Achilles_var_OM_FIA_IND = true;
Achilles_var_OM_NATO = true;
...
// CF_BAI
force force CF_BAI_subskills_maximum_aimingAccuracy = 0.3;
...
force force CF_BAI_subskills_maximum_spotDistance = 0.25;
...
// CF_BAI_detect
force force CF_BAI_detect_aiplayervision_max_distance = 500;
...
force force CF_BAI_detect_aivision_optics_range = 1200;
...
force force CF_BAI_suppression_bulletImpact = 0.45;
force force CF_BAI_suppression_commanding = 0.1;
force force CF_BAI_suppression_courage = 0.2;
force force CF_BAI_suppression_decay = 0.005;
force force CF_BAI_suppression_disableSuppression = false;
...
force force lambs_danger_CQB_range = 25;
...
force force lambs_danger_radio_backpack = 4000;
force force lambs_danger_radio_disabled = false;
force force lambs_danger_radio_EAST = 600;
force force lambs_danger_radio_GUER = 600;
force force lambs_danger_radio_shout = 80;
force force lambs_danger_radio_WEST = 600;
