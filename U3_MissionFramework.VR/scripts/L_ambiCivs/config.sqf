/* General config */
L_ambiCivs_maxCivs                 	= 35;		// Maximum number of civilians spawned at the same time
L_ambiCivs_minSpawnDistance 		= 200;		// Minimum distance to players when spawning civilians
L_ambiCivs_maxDistanceToPlayers    	= 800;		// Maximum distance to players, both for spawning and deleting civilians
L_ambiCivs_inhabitChance 			= 0.6;		// Population density. 0 = No house will be rendered suitable, 1 = every house will be suitable
...
L_ambiCivs_spawnCheckInterval 		= 2;		// How often the script will try to spawn a new civilian in seconds
