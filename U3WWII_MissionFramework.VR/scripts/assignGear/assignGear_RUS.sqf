...
_variant = "ussr";     // weapon
_camoPattern = "rkka_summer";    // uniform
_headgear = "rkka_h_summer";	// helmet type
_radioSelection = "russian";			// tfar radio selection
...
#include "assignGear_sectionLoadouts_rus.sqf";
...
#include "weapons\weapons_russian.sqf";   		// weapons classes
#include "uniforms\uniforms_Russian.sqf"; 		// uniform classes
