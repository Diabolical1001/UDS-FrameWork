...
_variant = "us_army";     // weapon
_camoPattern = "ranger";    // uniform
_headgear = "m1_ranger";	// helmet type
_radioSelection = "allies";			// tfar radio selection
...
_teamTwoDelta = "assault";					// weapons platform for second fireteam gunner/assistant - cases: rmteamone, rmteamtwo, assault
...
#include "assignGear_sectionLoadouts_all.sqf";
...
#include "weapons\weapons_usa.sqf";   		// weapons classes
#include "uniforms\uniforms_USA.sqf"; 		// uniform classes
...
if (_unit isKindOf "Man") then {
	...
	switch (_loadout) do {
		...
		case "rmfour" : {
			...
			_unit addPrimaryWeaponItem "LIB_M1918A2_BAR_Bipod";
