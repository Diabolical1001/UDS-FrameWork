...
_flag addaction ["<t color='#dddd00'>" + "Spawn Crate" + "</t>", {
	...
	[[_location, _boxType, _loadout], { _crate = (_this select 1) createVehicle (_this select 0); [_crate, (_this select 2)] call r_fnc_cratePicker_ALL }] remoteExec ["spawn", 2, false];
