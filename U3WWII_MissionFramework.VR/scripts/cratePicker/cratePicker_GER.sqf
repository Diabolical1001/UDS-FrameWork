...
_flag addaction ["<t color='#dddd00'>" + "Spawn Crate" + "</t>", {
	...
	_loadoutArray = [
		["Resupply - Squad", "Section_g_Ammo_F", "sectionammo"],
		["Resupply - Medical", "ace_medicalsupplycrate", "meds"],
		["Ammo - Rifle ", "Rifle_Ammo_g_F", "rifleammo"],
		["Ammo - MMG", "MG_Ammo_g_F", "mmgammo"],
		["Ammo - LAT", "LAT_Ammo_g_F", "latammo"],
		["Ammo - MAT", "MAT_Ammo_g_F", "matammo"],
		["Explosives - Demo", "LExplosives_Ammo_g_F", "demo"],
		["Explosives - AP Mines", "LExplosives_Ammo_g_F", "apmines"],
		["Explosives - AT Mines", "LExplosives_Ammo_g_F", "atmines"]
	];
	...
	[[_location, _boxType, _loadout], { _crate = (_this select 1) createVehicle (_this select 0); [_crate, (_this select 2)] call r_fnc_cratePicker_GER }] remoteExec ["spawn", 2, false];
